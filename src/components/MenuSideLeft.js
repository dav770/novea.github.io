...
function MenuSideLeft(props) {
  ...
  const IconTopBar = (currentSvg) => {
    props.displayIconBar(currentSvg);
  };

  return (
    <>
      <div className="side-left" style={{ paddingTop: "25%" }}>
        <div style={{ paddingBottom: "30%", width: "5%" }}>
          <svg
            ref={refSvg}
            aria-hidden="true"
            focusable="false"
        ...
        <div style={{ paddingBottom: "30%" }}>
          <svg
            ...
            height="30px"
            width="30px"
            onClick={() => handleClickIcon("random")}
          >
            <path
              fill="currentColor"
